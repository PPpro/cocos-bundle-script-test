...
export declare class NodeManager extends EventEmitter implements ISceneEvents {
     ...
     */
    pasteNode(target: string | null | undefined, uuids: string | string[], keepWorldTransform?: boolean): string[];
    /**
     * 挂载节点，如拖入和剪切
     * @param parent
     * @param uuids
     ...
     * @param keepWorldTransform
     */
    createNode(uuid: string | null | undefined, name: any, stashUuid: string | null, keepWorldTransform?: boolean): string | null | undefined;
    /**
     ...
     */
    createNodeFromAsset(parentUuid: string | undefined | null, assetUuid: string, options: CreateNodeOptions): Promise<any>;
    private _walkNode;
    /**
     * 删除节点
     * @param {*} uuids
